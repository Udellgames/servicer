namespace Servicer.Tests
{
    ...
    [TestFixture]
    public class ServiceLocatorDotNet4Tests
    {
        [Test]
        ...
        [Test]
        public void GetServiceAsync_TestSameType_TestAlreadyFulfilled_Keyed()
        {
            var expected = new List<string>()
            {
                "foo"
            ...
            ServiceLocator.GetServiceAsync<List<string>>(1).ContinueWith(x =>
            {
                Assert.That(x.Result, Is.EquivalentTo(expected));
                doneFired = true;
                waitHandle.Set();
            });
        ...
        [Test]
        public void GetServiceAsync_TestSameType_TestAlreadyFulfilled_Unkeyed()
        {
            var expected = new List<string>()
            {
                "foo"
            ...
            ServiceLocator.GetServiceAsync<List<string>>().ContinueWith(x =>
            {
                Assert.That(x.Result, Is.EquivalentTo(expected));
                doneFired = true;
                waitHandle.Set();
        ...
        [Test]
        public void GetServiceAsync_TestSameType_TestNotYetFulfilled_Keyed()
        {
            var expected = new List<string>()
            {
                "foo"
        ...
        [Test]
        public void GetServiceAsync_TestSameType_TestNotYetFulfilled_Unkeyed()
        {
            var expected = new List<string>()
            {
                "foo"
        ...
        [Test]
        public void GetServiceAsync_TestSuperClass_TestAlreadyFulfilled_Keyed()
        {
            var expected = new List<string>()
            {
                "foo"
            ...
            ServiceLocator.GetServiceAsync<IEnumerable<string>>(1).ContinueWith(x =>
            {
                Assert.That(x.Result, Is.EquivalentTo(expected));
                doneFired = true;
                waitHandle.Set();
        ...
        [Test]
        public void GetServiceAsync_TestSuperClass_TestAlreadyFulfilled_Unkeyed()
        {
            var expected = new List<string>()
            {
                "foo"
            ...
            ServiceLocator.GetServiceAsync<IEnumerable<string>>().ContinueWith(x =>
            {
                Assert.That(x.Result, Is.EquivalentTo(expected));
                doneFired = true;
                waitHandle.Set();
        ...
        [Test]
        public void GetServiceAsync_TestSuperClass_TestNotYetFulfilled_Keyed()
        {
            var expected = new List<string>()
            {
                "foo"
        ...
        [Test]
        public void GetServiceAsync_TestSuperClass_TestNotYetFulfilled_Unkeyed()
        {
            var expected = new List<string>()
            {
                "foo"
